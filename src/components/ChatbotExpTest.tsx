			...
			{endMessage ? (
				<div className="mt-20 rounded-lg bg-gray-400 p-6 text-white shadow-2xl">
					<div className="mb-4 rounded-md bg-[#1E2A38] p-4 font-mono text-sm">
						<textarea
							className="w-full whitespace-pre-wrap break-words rounded-md bg-[#1E2A38] p-2 text-white focus:outline-none"
							value={syntax}
							onChange={(e) => setSyntax(e.target.value)} // تحديث النص عند التعديل
							rows={5} // عدد الأسطر الافتراضية
						/>
					</div>
