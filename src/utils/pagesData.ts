...
AND e.department_id = 1;`,
    ...
    explanationParams: {
      ...
      howItWorks: "The SELECT statement is used to retrieve specific data from one or more database tables. It allows you to specify exactly which columns you want to see and filter the results based on certain conditions.",
...
WHERE salary > 50000 
AND department_id = 2;`,
        explanation: "This query retrieves the ID, name, and salary of employees who earn more than $50,000 and work in department 2.",
      },
      notes: [
      ...
      difficulty: "Beginner",
      tags: ["SELECT", "WHERE", "Filtering", "Basic Queries", "SQL Fundamentals"]
    }
  },
  insert: {
    exerciseParams: {
      title: "New Employee Registration",
      prompt: "Write a query to insert a new employee into the employees table with the following details: name='John Smith', position='Software Engineer', salary=75000, department_id=1.",
      tables: ['employees'],
      difficulty: "Easy",
      hints: [
...
VALUES ('John Smith', 'Software Engineer', 75000, 1);`,
    ...
    explanationParams: {
      ...
      howItWorks: "The INSERT statement adds new records to a database table. It requires specifying the target table, columns, and values to be inserted.",
      syntax: `INSERT INTO table_name (column1, column2, ...)
VALUES (value1, value2, ...);`,
      example: {
        code: `INSERT INTO employees (name, position, salary, department_id)
VALUES ('Alice Johnson', 'Data Analyst', 65000, 2);`,
        explanation: "This query adds a new employee named Alice Johnson as a Data Analyst with a salary of $65,000 in department 2.",
      },
      notes: [
  ...
  update: {
    exerciseParams: {
      ...
      prompt: "Write a query to give a 10% salary increase to all employees in the Engineering department (department_id = 1) who have been with the company for more than 5 years.",
      tables: ['employees'],
      difficulty: "Medium",
      hints: [
    ...
    explanationParams: {
      ...
      howItWorks: "The UPDATE statement modifies existing records in a database table. It can update multiple columns and rows simultaneously based on specified conditions.",
...
AND performance_rating > 4;`,
        explanation: "This query promotes developers to senior positions and gives them a $5,000 raise if they have high performance ratings.",
      },
      notes: [
  ...
  delete: {
    exerciseParams: {
      ...
      prompt: "Write a query to remove all employees who have resigned (status = 'resigned') and haven't worked in the last 30 days.",
      tables: ['employees'],
      difficulty: "Medium",
      hints: [
...
AND last_working_day < CURRENT_DATE - INTERVAL '30 days';`,
    ...
    explanationParams: {
      ...
      howItWorks: "The DELETE statement removes records from a database table based on specified conditions. It's permanent and should be used with caution.",
...
AND DATE_HIRED < CURRENT_DATE - INTERVAL '90 days';`,
        explanation: "This query removes employees from department 3 who have low performance ratings and have been employed for more than 90 days.",
      },
      notes: [
