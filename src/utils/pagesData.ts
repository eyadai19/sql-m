...
import type { MultipleChoiceExerciseProps as  MultipleChoiceParams} from "@/lib/types/exerciseTypes";
import type { DragDropExerciseProps as DragDropExerciseParams } from "@/lib/types/exerciseTypes";
			...
			questions: [
			  {
				...
				imageUrl: "/image/Education/Exercise/basic/erd/one-to-many-example.png",
				choices: [
